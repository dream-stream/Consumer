...
namespace Consumer.Services
{
    public class BrokerHandler
    {
        ...
        public static HttpClient[] AddBroker(string keyString, HttpClient[] brokerHttpClients)
        {
            ...
            var connectionString = EnvironmentVariables.IsDev ? "http://localhost:5041/" : $"http://{brokerName}.broker.default.svc.cluster.local/";
            var httpClient = new HttpClient { BaseAddress = new Uri(connectionString), Timeout = TimeSpan.FromSeconds(30) };
